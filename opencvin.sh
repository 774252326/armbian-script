...
sudo apt-get install libopenexr-dev libvtk6-dev python python-dev python-numpy libgtk2.0-dev libavcodec-dev libavformat-dev libswscale-dev libjpeg-dev libpng-dev libtiff-dev libjasper-dev libdc1394-22-dev libgphoto2-dev libeigen3-dev libgflags-dev libgoogle-glog-dev libprotobuf-dev libboost-all-dev libhdf5-serial-dev protobuf-compiler doxygen libgtk-3-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libgstreamer1.0-0-dbg libavresample-dev libsuitesparse-dev libleptonica-dev libtesseract-dev libatlas-dev libopenblas-dev -y
